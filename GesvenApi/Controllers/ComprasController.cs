...
public class ComprasController : ControllerBase
{
    ...
    public ComprasController(GesvenDbContext contexto, IMapper mapper, ILogger<ComprasController> logger, IEstatusLookupService estatusLookup)
    {
        _contexto = contexto;
        _mapper = mapper;
        _logger = logger;
    ...
    public async Task<ActionResult<RespuestaApi<OrdenCompraRespuestaDto>>> CrearOrdenCompra([FromBody] CrearOrdenCompraDto dto)
    {
        ...
        try
        {
            ...
            var respuesta = await _contexto.OrdenesCompra
                .Where(o => o.OrdenCompraId == ordenCompra.OrdenCompraId)
                .ProjectTo<OrdenCompraRespuestaDto>(_mapper.ConfigurationProvider)
                .FirstAsync();
