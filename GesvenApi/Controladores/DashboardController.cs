...
public class DashboardController : ControllerBase
{
    ...
    public DashboardController(GesvenDbContext contexto)
    {
        _contexto = contexto;
    }
    ...
    public async Task<ActionResult<RespuestaApi<DashboardResumenDto>>> ObtenerResumen([FromQuery] int? instalacionId = null)
    {
        ...
        var ordenesPendientes = await _contexto.OrdenesCompra
            .CountAsync(o => o.EstatusId == EstatusIds.Pendiente && (!instalacionId.HasValue || o.InstalacionId == instalacionId.Value));
        ...
        var ventasPendientesFacturar = await _contexto.Ventas
            .CountAsync(v => v.EstatusId == EstatusIds.Pendiente && (!instalacionId.HasValue || v.InstalacionId == instalacionId.Value));
