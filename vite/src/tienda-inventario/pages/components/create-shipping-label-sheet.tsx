      ...
      <SheetContent className="gap-0 lg:w-[940px] sm:max-w-none inset-5 border start-auto h-auto rounded-lg p-0 [&_[data-slot=sheet-close]]:top-4.5 [&_[data-slot=sheet-close]]:end-5">
          ...
          >
            <div className="flex flex-wrap lg:flex-nowrap px-3.5 grow">
              <div className="grow lg:border-e border-border lg:pe-5 space-y-5 py-5">
                ...
                <Card className="rounded-md">
                  <CardContent className="p-0">
                    ...
                    <div className="grid sm:grid-cols-4 gap-5 p-5">
                      {[
                        { label: 'ID de pedido', value: 'SO-AMS-4620' },
                        { label: 'Creado', value: '28 jul, 2025' },
                        { label: 'Precio total', value: '$320.00' },
                        { label: 'Prioridad de envío', value: 'Alta' },
                      ].map((item) => (
                ...
                <Card className="rounded-md">
                  <CardHeader className="min-h-[34px] bg-accent/50">
                    <CardTitle className="text-2sm">Equipo</CardTitle>
                  </CardHeader>
                ...
                <Card className="rounded-md">
                  <Tabs defaultValue="custom" className="w-full">
                    <CardHeader className="min-h-[40px] bg-accent/50">
                      <CardTitle className="text-sm">Empaque</CardTitle>
                      <TabsList
                        size="xs"
                    ...
                    <CardContent className="pt-1.5">
                      <TabsContent value="custom" className="space-y-4">
                        ...
                        <div className="grid sm:grid-cols-2 lg:gap-5 gap-2">
                          <div className="flex flex-col gap-2.5">
                            <Label className="text-xs">Tipo de paquete</Label>
                            <Select
                              defaultValue="medium-box"
                              indicatorPosition="right"
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Caja mediana" />
                              </SelectTrigger>
                              <SelectContent>
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            size="sm"
                          />
                          <Label>Guardar paquete para futuros pedidos</Label>
                        </div>
                      </TabsContent>
                      ...
                      <TabsContent value="carrier" className="space-y-4">
                        ...
                        <div className="grid sm:grid-cols-2 lg:gap-5 gap-2">
                          <div className="flex flex-col gap-2.5">
                            ...
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Caja grande" />
                              </SelectTrigger>
                              <SelectContent>
                                <SelectItem value="small-box">
                                  Caja pequeña
              ...
              <div className="w-full lg:w-[320px] lg:mt-5 space-y-5 lg:ps-5 shrink-0">
                <Card className="rounded-md">
                  <CardHeader className="min-h-[34px] bg-accent/50">
                    <CardTitle className="text-2sm">Resumen</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex flex-col gap-2">
                      <span className="text-sm font-medium text-foreground">
                        Envío a casa de Jeroen
                      </span>
                      <span className="text-2sm font-normal text-secondary-foreground">
                        Prinsengracht 24
                      </span>
                      <span className="text-2sm font-normal text-secondary-foreground">
                        1015 DV Ámsterdam, NL
                      </span>
                    </div>
        ...
        <SheetFooter className="flex items-center not-only-of-type:justify-between border-t py-5 px-5 border-border gap-2">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Button variant="mono">Comprar etiqueta de envío</Button>
          </div>
        </SheetFooter>
      </SheetContent>
    </Sheet>
