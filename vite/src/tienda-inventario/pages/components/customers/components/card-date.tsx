...
const cardData = [
  ...
  },
  {
    ...
    orders: [
      {
        product: "Urbano Flex Tejido Bajo",
        tooltip: "Urbano Flex Knit Low Top Shoes",
        sku: "KB-8820",
        image: "2.png",
        rating: 5,
    ...
    orders: [
      {
        ...
        image: "13.png",
        rating: 4,
        text: "Classic design that never goes out of style. The white leather is clean and easy to maintain. Confortable for all-day wear, though they run a bit narrow. Great value for a timeless sneaker."
      }
    ]
  },
  {
    ...
    orders: [
      {
        ...
        image: "15.png",
        rating: 3,
        text: "Simple and elegant design. The leather quality is good, but they took longer to break in than expected. Confortable once worn in, perfect for casual occasions."
      }
    ]
  }
];
