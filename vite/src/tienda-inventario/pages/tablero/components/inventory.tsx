...
const Inventory = ({}: InventoryProps) => {
  const items: InventoryItems = [
    { badgeColor: 'bg-green-500 size-2', label: 'Disponible' },
    { badgeColor: 'bg-yellow-500 size-2', label: 'Stock bajo' },
    { badgeColor: 'bg-destructive size-2', label: 'Sin stock' },
  ];

  const rows: InventoryRows = [
    { name: 'Tenis Shift Runner', qty: 4 },
