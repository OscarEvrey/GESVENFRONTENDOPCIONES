...
const datosMock: DetailsOrdersData[] = [
  {
    id: '1',
    order: 'SO-TX-4587',
    date: '18 ago, 2025',
...
export function DetailsOrdersTable({ datosMock: datosMockProps, displayProducts = false }: DetailsOrdersProps & { displayProducts?: boolean }) {
