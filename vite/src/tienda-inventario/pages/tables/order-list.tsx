...
interface OrderListProps {
  datosMock?: OrderListData[];
  displayProducts?: boolean;
}

// ---- MOCK DATA ----
const itemsPedidoMock: OrderItemData[] = [
  {
    id: '1',
    productInfo: {
      image: '11.png',
      ...
      label: 'WM-8421',
      tooltip: 'Air Max 270 React edición Engineered - Premium sneakers with advanced cushioning technology',
    },
    category: 'Tenis',
    price: '$83.00',
    trends: {
  ...
  },
  {
    ...
    productInfo: {
      ...
      label: 'UC-3990',
      tooltip: 'Corredor Trail Z2 - High-performance outdoor running shoes with superior grip',
    },
    category: 'Aire libre',
    price: '$110.00',
    trends: {
  ...
  },
  {
    ...
    productInfo: {
      image: '9.png',
      title: 'Urbano Flex Knit Low...',
      label: 'KB-8820',
      tooltip: 'Urbano Flex Knit Low - Confortable urban running shoes with flexible knit upper',
    },
    category: 'Corredores',
    price: '$76.50',
    trends: {
  ...
  },
  {
    ...
    productInfo: {
      ...
      label: 'LS-1033',
      tooltip: 'Clásico Calle Blaze - Timeless street style sneakers with modern comfort',
    },
    category: 'Tenis',
    price: '$69.99',
    trends: {
    ...
    thresholdLevel: 100,
    supplier: {
      name: 'Laboratorio Stock',
      logo: 'clusterhq.svg',
    },
  },
];

const datosMock: OrderListData[] = [
  {
    id: '1',
    order: 'SO-TX-4587',
    date: '18 ago, 2025',
...
const tabs = [
  ...
  { id: 'delivered', label: 'Entregado', badge: 26 },
  { id: 'returns', label: 'Returns', badge: 185 },
  { id: 'canceled', label: 'Canceled', badge: 49 },
];

// ---- MAIN TABLE COMPONENT ----
export function OrderListTable({ datosMock: datosMockProps, displayProducts = false }: OrderListProps & { displayProducts?: boolean }) {
  ...
  const filteredData = useMemo(() => {
    switch (activeTab) {
      case 'in-transit':
        return rawData.filter((d) => d.deliveryStatus.label === 'Enviado');
      case 'delivered':
        return rawData.filter((d) => d.paymentStatus.label === 'Pendiente');
      case 'returns':
        return rawData.filter(
          (d) =>
            d.paymentStatus.label === 'Cancelado' ||
  ...
  const columns = useMemo<ColumnDef<OrderListData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Pedido" column={column} />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Pago" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        cell: (info) => (
          ...
          >
            {info.row.original.items} artículos
          </div>
        ),
        enableSorting: true,
        size: 100,
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Estado de entrega" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Paquetería" column={column} />
        ),
        cell: (info) => (
      ...
      toast.custom(
        (t) => (
          ...
          >
            ...
            <AlertTitle>
              Filas seleccionadas: {selectedRowIds.join(', ')}
            </AlertTitle>
          </Alert>
        ),
        {
        ...
        <CardHeader className="py-3.5 flex-nowrap">
          ...
          <CardToolbar className="flex items-center gap-2">
            <Button
              ...
              asChild
            >
              <Link to="/tienda-inventario/detalles-pedido">
    ...
    () => [
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Información del producto" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Tendencias" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Reservado" column={column} />
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Umbral" column={column} />
        ),
  ...
  return (
    <div className="bg-muted/30 p-5">
      <div className="bg-card rounded-lg border border-muted-foreground/22">
        <DataGrid
          table={table}
          recordCount={itemsPedidoMock.length}
          tableLayout={{
            cellBorder: true,
            rowBorder: true,
