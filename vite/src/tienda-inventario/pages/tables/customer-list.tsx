...
export function CustomerListTable({
  ...
  const [data, setData] = useState(datosMock);
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="center" className="dark">
                ...
                <DropdownMenuItem onClick={() => handleGroupStatusChange('Pendiente')}>
                  Pendiente
                </DropdownMenuItem>
      ...
      <AlertDialog open={isGroupDeleteDialogOpen} onOpenChange={setIsGroupDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ¿Seguro que deseas eliminar <strong>{selectedRowsCount} clientes</strong>? 
              Esta acción no se puede deshacer. Todos los datos, pedidos y la información asociada se eliminarán de forma permanente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            >
              Eliminar {selectedRowsCount} clientes
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
