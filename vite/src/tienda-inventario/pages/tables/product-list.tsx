...
const datosMock: IData[] = [ 
  {
    ...
    productInfo: {
      image: '11.png',
      title: 'Nike Air Max 270 React edición Engineered',
      label: 'WM-8421',
  ...
  },
  {
    ...
    productInfo: {
      image: '2.png',
      title: 'Nike Urbano Flex Knit Low-Top Sneaker',
      label: 'KB-8820',
  ...
  },
  {
    ...
    productInfo: {
      image: '3.png',
      title: 'Salomon Enduro All-Terrain High-Alto rendimiento Trail Shoe',
      label: 'MS-8702',
