...
const datosMock: IData[] = [
  ...
  },
  {
    ...
    productInfo: {
      ...
      label: 'WC-5510',
      tooltip: 'Terra Trekking Max Pro Tenis',
    },
    dateOrder: '13 ago, 2025',
    qty: 200,
    stock: '$24,940.00',
    status: {
      label: 'Packed',
  ...
  },
  {
    id: '8',
    productInfo: {
      title: 'Enduro Todo Terreno Alta',
      label: 'MS-8702',
      tooltip: 'Tenis Enduro todo terreno alta',
    },
    dateOrder: '10 ago, 2025',
    qty: 100,
    stock: '$21000.00',
    status: {
      label: 'Allocated',
  ...
  },
  {
    ...
    arrivalDate: '7 ago, 2025',
    supplier: {
      name: 'Suministro Elite',
      logo: 'telcoin.svg',
    },
    carrier: 'FedEx',
  },
  ...
  },
  {
    ...
    arrivalDate: '5 ago, 2025',
    supplier: {
      name: 'Fuente Velocidad',
      logo: 'clusterhq.svg',
    },
    carrier: 'DHL',
  },
  ...
  },
  {
    ...
    arrivalDate: '2 ago, 2025',
    supplier: {
      name: 'Suministro Urbano',
      logo: 'quickbooks.svg',
    },
    carrier: 'UPS',
  },
...
const InboundStockTable = ({ datosMock: datosMockProps }: AllStockProps) => {
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Fecha de pedido" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title="Fecha de llegada" column={column} />
        ),
        cell: (info) => {
      ...
      },
      {
        id: 'tracking',
        header: ({ column }) => (
          <DataGridColumnHeader title="Seguimiento" column={column} />
        ),
        enableSorting: true,
        cell: (info) => (
          <>
