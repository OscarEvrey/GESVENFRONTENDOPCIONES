...
const datosMock: OutboundStockData[] = [
  {
    id: '1',
  ...
  },
  {
    ...
    productInfo: {
      ...
      label: 'MS-8702',
      tooltip: 'Enduro AllTerrain High Tenis',
    },
    qty: '100',
    status: {
      label: 'Entregado',
      ...
      >
        ...
        {createModalData && (
          <CreateShippingLabelSheet
            ...
            data={
              createModalData || (datosMock.length > 0 ? datosMock[0] : undefined)
            }
          />
        )}
          ...
          <CardHeader className="py-3.5">
            ...
            <CardToolbar>
              <Button
                variant="outline"
                onClick={() => {
                  setCreateModalData(datosMock[0]);
